...
| **CHK-H2-POOL-A2** | Hören A2 T2 picture_matching: claves no alineadas con diálogo/fichas a–i | 5 archivos pool, **7 CRITICAL** CHK-H2-ALIGN (+1 CHK-34 aparte en `horen-t3-gemini-074`) — audit 2026-08-07 | **Bloqueante activar Personalizado A2** — mismo bundle pre-launch que vocab-bg (`PROJECT-STATE-AUDIT` §4 P0). No afecta e1 live (usa `-cur-` Hören T2). Fix o retirar antes de pool personal Hören T2. |
