...
function consentStrings(lang) {
  const L = {
    en: {
      ...
      catAnalyticsHint: 'Not used today. Would help us understand usage if enabled later.',
    ...
    de: {
      ...
      catAnalyticsHint: 'Derzeit nicht genutzt. Würde später die Nutzung verstehen helfen.',
      catMarketing: 'Marketing',
    ...
    es: {
      ...
      catAnalyticsHint: 'No se usa hoy. Ayudaría a entender el uso si se activa más adelante.',
      catMarketing: 'Marketing',
    ...
    fr: {
      ...
      catAnalyticsHint: 'Non utilisé aujourd’hui. Aiderait à comprendre l’usage si activé plus tard.',
      catMarketing: 'Marketing',
