...
const PersonalLesenTopicStock = (() => {
  ...
  const MANIFEST = {
    ...
    teils: [1, 2, 3, 4, 5],
    topics: [
      { topic: 'Reisen', counts: { '1': 3, '2': 2, '3': 0, '4': 1, '5': 0 }, total: 6, filled: 3, missing: [3, 5], full: false, status: 'partial' },
      { topic: 'Gesundheit', counts: { '1': 0, '2': 0, '3': 0, '4': 0, '5': 1 }, total: 1, filled: 1, missing: [1, 2, 3, 4], full: false, status: 'sparse' },
      { topic: 'Arbeit', counts: { '1': 2, '2': 0, '3': 1, '4': 0, '5': 2 }, total: 5, filled: 3, missing: [2, 4], full: false, status: 'partial' },
      { topic: 'Technik', counts: { '1': 4, '2': 3, '3': 1, '4': 4, '5': 4 }, total: 16, filled: 5, missing: [], full: true, status: 'full' },
      { topic: 'Medien', counts: { '1': 1, '2': 0, '3': 0, '4': 0, '5': 2 }, total: 3, filled: 2, missing: [2, 3, 4], full: false, status: 'sparse' },
      { topic: 'Wohnen', counts: { '1': 8, '2': 0, '3': 4, '4': 7, '5': 4 }, total: 23, filled: 4, missing: [2], full: false, status: 'partial' },
      { topic: 'Konsum', counts: { '1': 1, '2': 4, '3': 0, '4': 1, '5': 0 }, total: 6, filled: 3, missing: [3, 5], full: false, status: 'partial' },
      { topic: 'Bildung', counts: { '1': 7, '2': 1, '3': 2, '4': 8, '5': 1 }, total: 19, filled: 5, missing: [], full: true, status: 'full' },
      { topic: 'Familie', counts: { '1': 0, '2': 0, '3': 0, '4': 3, '5': 0 }, total: 3, filled: 1, missing: [1, 2, 3, 5], full: false, status: 'sparse' },
      { topic: 'Umwelt', counts: { '1': 2, '2': 2, '3': 0, '4': 2, '5': 1 }, total: 7, filled: 4, missing: [3], full: false, status: 'partial' },
      { topic: 'Ernährung', counts: { '1': 2, '2': 2, '3': 1, '4': 18, '5': 2 }, total: 25, filled: 5, missing: [], full: true, status: 'full' },
      { topic: 'Kultur', counts: { '1': 1, '2': 3, '3': 1, '4': 0, '5': 1 }, total: 6, filled: 4, missing: [4], full: false, status: 'partial' },
      { topic: 'Sport', counts: { '1': 1, '2': 1, '3': 1, '4': 0, '5': 0 }, total: 3, filled: 3, missing: [4, 5], full: false, status: 'sparse' },
      { topic: 'Freizeit', counts: { '1': 24, '2': 1, '3': 0, '4': 9, '5': 1 }, total: 35, filled: 4, missing: [3], full: false, status: 'partial' },
      { topic: 'Verkehr', counts: { '1': 3, '2': 0, '3': 1, '4': 1, '5': 2 }, total: 7, filled: 4, missing: [2], full: false, status: 'partial' },
      { topic: 'Stadtleben', counts: { '1': 2, '2': 1, '3': 0, '4': 4, '5': 1 }, total: 8, filled: 4, missing: [3], full: false, status: 'partial' },
    ],
  };
