 ...
 *
 * batches/ready/lesen/ es espejo de batches/generated/: el mismo ID lógico no debe
 * aparecer dos veces en el índice. Prioridad al colapsar rutas:
 *   bank (passages publicados) > ready > generated
 *
...
/** @returns {number} 3=bank, 2=ready, 1=generated, 0=otro */
export function sourceTier(source) {
  const s = String(source || '');
  if (s.startsWith('library/')) return 3;
