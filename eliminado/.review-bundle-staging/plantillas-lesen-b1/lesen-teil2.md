...
4. **Parafraseo B1 en preguntas/opciones/explanations (OBLIGATORIO):** vocabulario **≤ B1** — el sinónimo **NO puede ser más difícil** que el pasaje. **PROHIBIDO** en preguntas: *modifizieren*, *Gelassenheit*, *Angehörige*, *elektronische Mitteilungen*, *sich austauschen*, jerga corporativa (*Marke stärken*, *Priorität*, *Potenzial*…).
5. Las **3 opciones** plausibles; las incorrectas = datos del texto **mal aplicados** o **incompletos**.
6. La opción correcta **NO copia 4+ palabras seguidas** del pasaje.
7. **Distribución equilibrada de claves:** en las 6 preguntas, máximo 2 con la misma letra correcta. Distribuye: 2× a, 2× b, 2× c.
8. **Tema único:** si el prompt fija un tema (p. ej. Technik), **los DOS textos** deben tratar ese tema; `topicTag` de **cada** passage = ese tema.
