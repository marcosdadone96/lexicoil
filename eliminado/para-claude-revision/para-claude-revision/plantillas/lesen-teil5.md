...
- **8–12 palabras** (no 15). Intégralas en el **texto normativo**, no en las preguntas.
...
```json
{
  ...
  "questions": [
    ...
    },
    {
      ...
      "correct": "b",
      "correctAnswer": "b",
      "explanation": "Große Sachen nur mit Termin bei der Organisation.",
      "passageId": "gen-l5-8842",
      "lang": "de",
      "level": "B1"
    },
    {
      ...
      "options": [
        ...
        "b) In dem dafür vorgesehenen Nebenraum beim Waschen.",
        "c) Auf den Gästeparkplätzen."
      ],
      "correct": "b",
      "correctAnswer": "b",
